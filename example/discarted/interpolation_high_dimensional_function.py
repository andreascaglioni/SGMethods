...
from SGMethods.multi_index_sets import anisoSmolyakMidSet, midSet
...
TPInterpolant = lambda activeNodesTuple, fOnNodes : \
    RegularGridInterpolator(activeNodesTuple, fOnNodes, method='linear', bounds_error=False, fill_value=None)
