...
"""we approximate the SLLG problem with piecewise linear sparse grids using the optimal midset. 
...
for N in NN:
    ...
    while(True):
        ...
        print("Error:", err[w])
        np.savetxt('convergenge_pwLin_aniso_SLLG_'+str(N)+'.csv',np.array([nNodes, err]))
