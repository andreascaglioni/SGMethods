...
def error_sample(dofscurr, dofsref, Nhref, Ntauref, Nh, Ntau, T, r, p, DT_ERROR):
    ...
    # 1 PREPARE REFERENCE
    meshref = BoxMesh(Point(0, 0, 0), Point(1, 1, 0.1), Nhref, Nhref, ceil(Nhref/10.))
    ...
    if len(dofscurr) != Nt*dimV3:
        print("mismatch crrrent sol:", len(dofscurr), " != ", Nt, " * ", dimV3)
    ...
    Pr = FiniteElement('P', tetrahedron, 1)
